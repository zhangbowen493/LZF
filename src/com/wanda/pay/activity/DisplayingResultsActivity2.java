 ...
 */
public class DisplayingResultsActivity2 extends BaseActivity implements
OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_show_transfer_success);
	...
	private void initData() {
		...
		number=getIntent().getStringExtra("otherAccount");
