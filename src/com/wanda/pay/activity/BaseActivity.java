...
public class BaseActivity extends Activity {
	...
	protected void onRestart() {
		...
		if (!isCurrentRunningForeground
				&& !(topActivityClassName.endsWith("LoginActivity")
						|| WDApplication.isBackGround
	...
	public boolean isRunningMyForeground() {
		...
		String topActivityClassName = getTopActivityName(this);
		if (topActivityClassName.endsWith("LoginActivity")
				|| topActivityClassName
				.endsWith("RegisteredInputPhoneActivity")
				|| topActivityClassName
				.endsWith("RegisteredCheckPhoneActivity")) {
			return false;
		}
	...
	private void CheckLoginTime() {
		...
		if (userBean != null) {
			...
			.showProgressDialog(BaseActivity.this, "用户超时验证");
		}
	}
